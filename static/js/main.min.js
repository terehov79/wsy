...
(function ($) {
  ...
  tabsGlobal('click', '.btn_tabs', '.services__buttons', 'tab--active', '.services__cell', '.services__box');
  tabsGlobal('click', '.btn_tabs-js', '.react__js-main', 'tab-js--active', '.react__info', '.react__box');
})(jQuery);